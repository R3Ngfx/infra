// Example - Porting shader from shadertoy
// License: MIT
// ------------
// There are two main changes that need to be done in order to port a shader from shadertoy to infra:
// - Change the declaration of the main function mainImage to void main(void)
// - Change the names of built-in input variables (see the provided macros in this file)
...
// Helpful macros for quickly porting shadertoy code
#define fragColor outCol
#define fragCoord (vec2(gl_FragCoord.x, resolution.y)-vec2(0,gl_FragCoord.y))
...
#define iChannel3 tex3

// The following code is iq's "Raymarching - Primitives"
// -----------------------------------------------------
