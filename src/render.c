...
int loadTexture() {
	...
	for (int i = 0; i < loadedTextures; i++) {
		...
		glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, textureFilters[currentFilter]);
		glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, textureFilters[currentFilter]);
